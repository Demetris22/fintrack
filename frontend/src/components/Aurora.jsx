...
function getColorStopValues(colorStops) {
...
export default function Aurora({
  colorStops = ["#2458d3", "#0f8a5f", "#b9c8ff"],
  amplitude = 0.55,
  blend = 0.28,
  speed = 0.35,
  className = "",
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uColorStops: { value: getColorStopValues(colorStops) },
    ...
    const update = (time) => {
      ...
      program.uniforms.uColorStops.value = getColorStopValues(colorStops);
